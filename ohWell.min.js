...
-1==k.indexOf("safari")||-1<k.indexOf("chrome")||(l.canvas.style.maxHeight="100%",l.canvas.style.minHeight="100%");l.scale=f};l.shake=function(d,e){var f=1,k=d.x;startY=d.y;e=e||64;d.updateShake=function(){10>f&&(d.x=k,d.y=startY,e-=f,d.x=l.random(-e,e),d.y=l.random(-e,e),f+=1);10<=f&&(d.x=k,d.y=startY,l.shakingSprites.splice(l.shakingSprites.indexOf(d),1))};l.shakingSprites.push(d)}};
